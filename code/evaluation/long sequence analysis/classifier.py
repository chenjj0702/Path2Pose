...
class Classifier_Cnn_35(nn.Module):
    """
    3D卷积分类器 t=40
    """

    def __init__(self):
        super(Classifier_Cnn_35, self).__init__()
        ...
        self.net1 = nn.Sequential(
            ...
            nn.Conv3d(128, 256, kernel_size=(4, 2, 1), stride=2),
            nn.BatchNorm3d(256),
            nn.LeakyReLU(),

            nn.Conv3d(256, 256, kernel_size=(4, 3, 1), stride=2),
            nn.BatchNorm3d(256),
            nn.LeakyReLU(),
            ...
            nn.Conv3d(256, 256, kernel_size=(3, 1, 1), stride=1),
