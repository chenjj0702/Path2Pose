...
if __name__ == '__main__':
    ...
    args.save_dir = args.code_root_dir + args.obj_dir + 'seq_nrds_gcn3_all_epoch'  # 二级目录

    data_dir = Path(
        '/data/cjj/DLSpace/results/path2pose/')  # D:/Data/DLSpace/results/path2pose ; /data/cjj/DLSpace/results/path2pose/
    mode_list = [
    ...
    npz_list = [  # todo
        'v11_public_attncn_220812_202737/val/epoch10000/test_results.npz',
        'v11_public_attncn_220812_202737/val/epoch20000/test_results.npz',
        'v11_public_attncn_220812_202737/val/epoch30000/test_results.npz',
        'v11_public_attncn_220812_202737/val/epoch40000/test_results.npz',
        'v11_public_attncn_220812_202737/val/epoch50000/test_results.npz',
        'v11_public_attncn_220812_202737/val/epoch60000/test_results.npz',

        'v11_public_gcn3_220815_201054/val/epoch10000/test_results.npz',
        'v11_public_gcn3_220815_201054/val/epoch20000/test_results.npz',
        'v11_public_gcn3_220815_201054/val/epoch30000/test_results.npz',
        'v11_public_gcn3_220815_201054/val/epoch40000/test_results.npz',

        'v11_public_rnn_220812_203203/val/epoch10000/test_results.npz',
        'v11_public_rnn_220812_203203/val/epoch20000/test_results.npz',
        'v11_public_rnn_220812_203203/val/epoch30000/test_results.npz',
        'v11_public_rnn_220812_203203/val/epoch40000/test_results.npz',
    ]
